        ...
        <div className="max-w-md mx-auto space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-[#605BFF] text-white rounded-lg font-medium hover:bg-green-600 transition-colors"
                >
                  Yes
                </button>
                <button
                  onClick={() => handleAgreement(false)}
                  className="flex-1 py-3 px-4 bg-white text-white rounded-lg font-medium hover:bg-red-600 transition-colors"
                >
                  No
                </button>
              </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="px-3 py-1 bg-yellow-200 text-yellow-800 rounded text-xs font-medium hover:bg-yellow-300 transition-colors">
                Upgrade
              </button>
            </div>
